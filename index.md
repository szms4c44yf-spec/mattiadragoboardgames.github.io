...
<div class="hero">
  <div class="hero__inner">
    ...
    <a class="btn-cta" href="#posts">Vai agli articoli</a>
  </div>
</div>

## Ultimi articoli {#posts}
...
<p class="rss" style="margin-top:1rem; opacity:.85;">
  Iscriviti via <a href="{{ '/feed.xml' | relative_url }}">RSS</a>
</p>
